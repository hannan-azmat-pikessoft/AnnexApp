...
import { SCREEN_LOGIN, SCREEN_SIGNUP, SCREEN_VERIFICATION } from '../utility/constants';
...
function AuthNavigator() {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }} >
            <Stack.Navigator initialRouteName={SCREEN_LOGIN} screenOptions={{ headerShown: false, cardStyleInterpolator: CardStyleInterpolators.forHorizontalIOS }}>
                <Stack.Screen name={SCREEN_LOGIN} component={Login} />
                <Stack.Screen name={SCREEN_VERIFICATION} component={VerificationScreen} />
