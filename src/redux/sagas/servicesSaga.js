...
export function* getFeaturedServiceCategoryWatcher() {
    yield takeLatest(actionTypes.FEATURED_SERVICE_CATEGORY_METHOD, getFeaturedServiceCategoryWorker)
}
...
export function* getServiceCategoryWatcher() {
    yield takeLatest(actionTypes.SERVICE_CATEGORY_METHOD, getServiceCategoryWorker)
}
