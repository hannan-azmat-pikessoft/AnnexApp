  ...
  switch (action.type) {
    case actionTypes.FEATURED_SERVICE_CATEGORY_METHOD:
      return {
        ...state,
        featuredServiceCategoryFetching: true,
        featuredServiceCategoryError: null,
        isFeaturedServiceCategorySuccess: false,
      };
      break;
    case actionTypes.FEATURED_SERVICE_CATEGORY_SUCCESS:
      return {
        ...state,
        featuredServiceCategoryFetching: false,
        featuredServiceCategoryError: null,
        featuredServiceCategoryRes: action.payload,
        isFeaturedServiceCategorySuccess: true,
      };
      break;
    case actionTypes.FEATURED_SERVICE_CATEGORY_FAIL:
      return {
        ...state,
        featuredServiceCategoryFetching: false,
        featuredServiceCategoryError: action.error,
        featuredServiceCategoryRes: state.featuredServiceCategoryRes,
        isFeaturedServiceCategorySuccess: false,
      };
      break;
    case actionTypes.FEATURED_SERVICE_CATEGORY_CLEAR:
      return {
        ...state,
        featuredServiceCategoryFetching: false,
        featuredServiceCategoryError: undefined,
        featuredServiceCategoryRes: null,
        isFeaturedServiceCategorySuccess: false,
      };
      break;
    ...
    case actionTypes.SERVICE_CATEGORY_METHOD:
      return {
        ...
        isServiceCategorySuccess: false,
      };
      break;
    case actionTypes.SERVICE_CATEGORY_SUCCESS:
      return {
        ...
        serviceCategoryError: null,
        serviceCategoryRes: action.payload,
        isServiceCategorySuccess: true,
      };
      break;
    case actionTypes.SERVICE_CATEGORY_FAIL:
      return {
        ...state,
        serviceCategoryFetching: false,
        serviceCategoryError: action.error,
        serviceCategoryRes: state.serviceCategoryRes,
        isServiceCategorySuccess: false,
      };
      break;
    case actionTypes.SERVICE_CATEGORY_CLEAR:
      return {
        ...state,
        serviceCategoryFetching: false,
        serviceCategoryError: undefined,
        serviceCategoryRes: null,
        isServiceCategorySuccess: false,
      };
      break;
