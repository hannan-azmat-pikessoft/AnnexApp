                ...
                <TouchableOpacity activeOpacity={1} style={styles.visibleViewStyle}>
                    <View style={{ flex: 1 }}>
                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                            <CommonImage source={Images.IMG_ERROR_ICON} />
                            <RegularText style={styles.title} >{Strings.uh_oh + "!"}</RegularText>
                            <RegularText style={styles.msgStyle} >{Strings.msg_no_internet_connection_found}</RegularText>
                        </View>
                        <CommonButton title={Strings.refresh} buttonStyle={styles.buttonStyle} />
                    </View>
                </TouchableOpacity>
            </TouchableOpacity>
        </Modal>
