  ...
  return (
    <View
      style={{
        ...
        marginLeft: index == 0 ? spacing.MARGIN_18 : 0,
...
const ServiceDescription = ({
  ...
  const {serviceInCart, totalServicePriceWithVAT} = useSelector(
    state => state.bookServiceReducer,
  );
  ...
  function onFinishRecording(obj) {
  ...
  return (
    <VirtualizedView style={styles.mainContainer}>
      <View style={styles.infoContainer}>
        <RegularText style={styles.infoContainer_heading}>
          {serviceInCart.service.name}
        </RegularText>
        <RegularText style={styles.infoContainer_description}>
          {serviceInCart.service.description}
        </RegularText>
      </View>
      <View style={styles.descriptionContainer}>
        <RegularText style={styles.descriptionContainer_title}>
          {Strings.please_add_any_specific_instruction}
        </RegularText>
      ...
      {hasVoiceNote && (
        <AudioAttachmentRow
          item={voiceNote}
          onPressRemove={onPressDeleteAudio}
