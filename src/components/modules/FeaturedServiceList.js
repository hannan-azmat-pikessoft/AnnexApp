      ...
      <SkeletonPlaceholder>
        <SkeletonPlaceholder.Item
          ...
          <SkeletonPlaceholder.Item
            ...
            paddingVertical={spacing.PADDING_12}></SkeletonPlaceholder.Item>
        </SkeletonPlaceholder.Item>
      </SkeletonPlaceholder>
    </Animatable.View>
  );
...
const FeaturedServiceList = () => {
  ...
  const {
    featuredServiceCategoryFetching,
    featuredServiceCategoryRes,
    isFeaturedServiceCategorySuccess,
  ...
  return (
    <View key={'featuredServiceListComponent'} style={styles.mainContainer}>
      {featuredServiceCategoryRes.results.length > 0 && (
        <RegularText style={styles.title}>
          {Strings.featured_services}{' '}
        </RegularText>
      )}
      <FlatList
        data={
          !featuredServiceCategoryFetching
            ? featuredServiceCategoryRes.results
            : [1, 1, 1, 1]
        }
