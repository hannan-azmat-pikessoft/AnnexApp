      ...
      {isLoading ? (
        ...
        <TouchableOpacity
          ...
          <CommonImage
            ...
            style={[
              styles.imageStyle,
              !isFeatured && {borderRadius: spacing.RADIUS_8},
            ]}
            resizeMode={'cover'}
          />
          {item.is_lunched &&
            item.cheapest_price.actual_price &&
            item.cheapest_price.price && (
              <View
                style={{
                ...
                <RegularText
                  style={{
                    ...
                    textDecorationColor: colors.orange700,
                  }}>
                  {item.cheapest_price.actual_price}
                </RegularText>
                <RegularText
                  style={{
                    ...
                    fontSize: textScale(9),
                    fontFamily: fontNames.FONT_FAMILY_BOLD,
                  }}>{` ${item.cheapest_price.price}`}</RegularText>
              </View>
            )}
          {!item.is_lunched && (
            <View
              ...
              <RegularText style={styles.comingSoonText}>
                {Strings.coming_soon}
              </RegularText>
            </View>
          )}
          <View style={styles.secondaryView}>
            ...
            <RegularText style={styles.cardDescription} numberOfLines={2}>
              {item.description}
            </RegularText>
          </View>
        </TouchableOpacity>
